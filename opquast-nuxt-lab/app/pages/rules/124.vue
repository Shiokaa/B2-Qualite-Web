  ...
  <div class="rounded-xl border border-zinc-800 bg-zinc-950 p-5">
    <div class="space-y-4">
      ...
      <div class="relative rounded-lg overflow-hidden bg-black">
        <div class="aspect-video relative">
          ...
          <button class="absolute inset-0 flex items-center justify-center group">
            <div class="w-20 h-20 rounded-full bg-white/90 group-hover:bg-white flex items-center justify-center transition shadow-lg">
              <svg class="w-10 h-10 text-zinc-900 ml-1" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div class="text-sm text-zinc-400">
        ...
        <p class="mt-1">La vidéo ne se lance que lorsque l'utilisateur clique sur le bouton de lecture.</p>
      </div>
    </div>
  </div>
    ...
    <div class="flex items-start gap-3">
      ...
      <div>
        ...
        <p class="mt-1 text-sm text-red-200/80">
          Vidéo avec <code class="px-1.5 py-0.5 rounded bg-red-900/40 text-red-200">autoplay</code> activé, qui démarre automatiquement au chargement de la page.
        </p>
      </div>
    </div>
  </div>
...
&gt;&lt;/iframe&gt;
  ...
  <div class="mt-4 space-y-3">
    <div class="rounded-lg border border-zinc-800 bg-zinc-900/50 p-4">
      <p class="text-xs font-medium text-zinc-300">💡 Bonnes pratiques</p>
      <ul class="mt-2 space-y-1.5 text-xs text-zinc-400">
        <li>• Toujours inclure l'attribut <code class="text-zinc-300">controls</code></li>
        <li>• Définir une image de prévisualisation avec <code class="text-zinc-300">poster</code></li>
        <li>• Fournir des sous-titres avec <code class="text-zinc-300">&lt;track&gt;</code></li>
        <li>• Ne jamais utiliser <code class="text-zinc-300">autoplay</code> sans <code class="text-zinc-300">muted</code></li>
        <li>• Pour les vidéos d'ambiance, utiliser <code class="text-zinc-300">autoplay muted loop</code></li>
      </ul>
    </div>

    <p class="text-xs text-zinc-500">
      Le contrôle utilisateur sur la lecture des vidéos est essentiel pour l'accessibilité, 
